...
final exampleOutput = Output.fromAddress(
  BigInt.from(100000),
  Address.fromString("PSUVJAon4oTrVZgHEKg3UfppFEDP7gBSkt", Network.mainnet),
);
...
final validTxVecs = [
  ...
  TxVector(
    obj: Transaction(version: 3, inputs: [], outputs: []),
...
final ambiguousWitness = TxVector(
  obj: Transaction(
    ...
    outputs: [
      Output.fromScriptBytes(BigInt.parse("578437695752307201"), Uint8List(0)),
    ],
  ),
  hashHex: "c484fd792a2b6abc72572da2fdfbe207edbab594b5b3d7fa0e7963b78c29c60a",
