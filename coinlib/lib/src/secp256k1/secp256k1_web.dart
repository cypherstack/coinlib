...
class Secp256k1
    extends Secp256k1Base<int, int, int, int, int, int, int, int, int, int> {
  ...
  Future<void> internalLoad() async {
    ...
    // Set functions
    extEcSeckeyVerify =
        inst.functions["secp256k1_ec_seckey_verify"] as IntFunc2;
    extEcSeckeyVerify =
        inst.functions["secp256k1_ec_seckey_verify"] as IntFunc2;
    extEcPubkeyCreate =
        inst.functions["secp256k1_ec_pubkey_create"] as IntFunc3;
    extEcPubkeySerialize =
        inst.functions["secp256k1_ec_pubkey_serialize"] as IntFunc5;
    extEcPubkeyParse = inst.functions["secp256k1_ec_pubkey_parse"] as IntFunc4;
    extEcdsaSign = inst.functions["secp256k1_ecdsa_sign"] as IntFunc6;
    extEcdsaSignatureSerializeCompact =
        inst.functions["secp256k1_ecdsa_signature_serialize_compact"]
            as IntFunc3;
    extEcdsaSignatureParseCompact =
        inst.functions["secp256k1_ecdsa_signature_parse_compact"] as IntFunc3;
    extEcdsaSignatureNormalize =
        inst.functions["secp256k1_ecdsa_signature_normalize"] as IntFunc3;
    extEcdsaSignatureSerializeDer =
        inst.functions["secp256k1_ecdsa_signature_serialize_der"] as IntFunc4;
    extEcdsaSignatureParseDer =
        inst.functions["secp256k1_ecdsa_signature_parse_der"] as IntFunc4;
    extEcdsaVerify = inst.functions["secp256k1_ecdsa_verify"] as IntFunc4;
    ...
    extEcdsaSignRecoverable =
        inst.functions["secp256k1_ecdsa_sign_recoverable"] as IntFunc6;
    extEcdsaRecover = inst.functions["secp256k1_ecdsa_recover"] as IntFunc4;
    extEcSeckeyTweakAdd =
        inst.functions["secp256k1_ec_seckey_tweak_add"] as IntFunc3;
    extEcPubkeyTweakAdd =
        inst.functions["secp256k1_ec_pubkey_tweak_add"] as IntFunc3;
    extEcSeckeyNegate =
        inst.functions["secp256k1_ec_seckey_negate"] as IntFunc2;
    extKeypairCreate = inst.functions["secp256k1_keypair_create"] as IntFunc3;
    extXOnlyPubkeyParse =
        inst.functions["secp256k1_xonly_pubkey_parse"] as IntFunc3;
    extSchnorrSign32 =
        inst.functions["secp256k1_schnorrsig_sign32"] as IntFunc5;
    extSchnorrVerify =
        inst.functions["secp256k1_schnorrsig_verify"] as IntFunc5;
    extEcdh = inst.functions["secp256k1_ecdh"] as IntFunc6;

    // Local functions for loading purposes
    final contextCreate =
        inst.functions["secp256k1_context_create"] as IntFunc1;
    final contextRandomize =
        inst.functions["secp256k1_context_randomize"] as IntFunc2;
