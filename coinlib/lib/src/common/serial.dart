...
class BytesReader extends _ReadWriteBase {
  ...
  int readUInt16() =>
      _requireBytes(2, () => bytes.getUint16((offset += 2) - 2, Endian.little));
  int readUInt32() =>
      _requireBytes(4, () => bytes.getUint32((offset += 4) - 4, Endian.little));
  int readInt32() =>
      _requireBytes(4, () => bytes.getInt32((offset += 4) - 4, Endian.little));
...
class BytesWriter extends _ReadWriteBase with Writer {
  ...
  writeUInt16(int i) {
    ...
    _requireBytes(
      2,
      () => bytes.setUint16((offset += 2) - 2, i, Endian.little),
    );
  }
  ...
  writeUInt32(int i) {
    ...
    _requireBytes(
      4,
      () => bytes.setUint32((offset += 4) - 4, i, Endian.little),
    );
  }
  ...
  writeInt32(int i) {
    checkInt32(i);
    _requireBytes(4, () => bytes.setInt32((offset += 4) - 4, i, Endian.little));
  }
  ...
  writeSlice(Uint8List slice) => _requireBytes(slice.length, () {
