...
/// Compiles the vendored secp256k1-coinlib into a shared library that is
/// bundled with the application and bound to the `@Native` functions in
/// `lib/src/secp256k1/secp256k1.ffi.g.dart`.
///
/// This mirrors the configuration that was previously used with the CMake
/// builds: -O2, the ecdh, extrakeys, musig, recovery and schnorrsig modules,
/// a window size of 15 and the 86 KiB signing table.
  ...
  await build(args, (input, output) async {
    ...
    final builder = CBuilder.library(
      ...
      defines: {
        ...
        // Precomputed table sizes: SECP256K1_ECMULT_WINDOW_SIZE=15 and
        // SECP256K1_ECMULT_GEN_KB=86 as used by the Flutter plugin build.
        'ECMULT_WINDOW_SIZE': '15',
        'COMB_BLOCKS': '43',
        'COMB_TEETH': '6',
        // Use the x86_64 inline assembly in the scalar implementation where
        // the compiler is GCC or Clang, as the CMake build does.
